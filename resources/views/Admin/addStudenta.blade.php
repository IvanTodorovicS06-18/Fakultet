                ...
                <div class="card-body" style="font-family: sans-serif">
                    <form action="/student-save" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" @error('broj_indeksa') is-invalid @enderror id="broj_indeksa" value="{{ old('broj_indeksa') }}" required autocomplete="broj_indeksa" name="broj_indeksa" >
                            @error('broj_indeksa')
                            <p> {{$message}}</p>
                            @enderror
